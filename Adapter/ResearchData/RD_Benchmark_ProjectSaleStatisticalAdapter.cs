...
{
    /// <summary>
    /// 客研数据_对标_项目销售统计Adapter
    /// </summary>
    public class RD_Benchmark_ProjectSaleStatisticsAdapter : UpdatableAndLoadableAdapterBase<RD_Benchmark_ProjectSaleStatisticsModel, RD_Benchmark_ProjectSaleStatisticsCollection>
    {
        /// <summary>
        /// 实例
        /// </summary>
        public static readonly RD_Benchmark_ProjectSaleStatisticsAdapter Instance = new RD_Benchmark_ProjectSaleStatisticsAdapter();
        ...
        /// 批量插入数据
        /// </summary>
        public void BatchInsert(List<RD_Benchmark_ProjectSaleStatisticsModel> list)
        {
            ...
            SqlDbHelper.BulkInsertData(dt, "office.RD_Benchmark_ProjectSaleStatistics", GetConnectionName());
        }
        ...
        /// <returns></returns>
        public List<RD_Benchmark_ProjectSaleStatisticsModel> GetNHM_AnnualStatisticsByRD_Code(string code)
        {
