...
namespace Seagull2.YuanXin.AppApi.Pay.Alipay
{
    ...
    public class Core
    {
        ...
        /// <summary>
        /// 把数组所有元素，按照“参数=参数值”的模式用“连接符”拼接成字符串
        /// </summary>
        ...
        /// <summary>
        /// 把数组所有元素，按照“参数=参数值”的模式用“连接符”拼接成字符串，并对参数值做urlencode
        /// </summary>
        /// <param name="dicArray">需要拼接的数组</param>
        ...
        {
            string strPath = HttpRuntime.AppDomainAppPath.ToString() + "\\log";
            strPath = strPath + "\\" + DateTime.Now.ToString("yyyyMMddhhmmssffff") + ".txt";
            FileStream fs = new FileStream(strPath, FileMode.OpenOrCreate, FileAccess.ReadWrite, FileShare.ReadWrite);
