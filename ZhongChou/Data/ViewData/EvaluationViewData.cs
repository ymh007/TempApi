...
namespace Seagull2.YuanXin.AppApi.ZhongChouData.ViewData
{
    ...
    /// 
    /// </summary>
    public class EvaluationViewData : UserEvaluation
    {
        /// <summary>
        /// 行号
        /// </summary>
        ...
        /// 获取回复列表
        /// </summary>
        public UserEvaluationCollection ReEvaluationList
        {
            get
            {
                return UserEvaluationAdapter.Instance.LoadByReEvaluation(Code);
            }
        }
        /// <summary>
        /// 重写projectName
    ...
    public class EvaluationViewDataCollection : EditableDataObjectCollectionBase<EvaluationViewData>
    {
        /// <summary>
        /// 转化为ListDataView
        /// </summary>
